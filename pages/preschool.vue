          ...
          <div class="row pb-45">
             <div class="col-lg-7">
                <div class="tp-service-hero-left p-relative z-index-1 mb-40">
                   <h2 class="fs-70 fs-lg-60 fs-xs-40" style="color: #E83F4B;">Preescolar</h2>
                   <h2 class="fs-40 fs-lg-60 fs-xs-40 h2-montserrat" style="color: #E83F4B;">Preschool</h2>
                   <div class="tp-service-details-icon">
                      <img class="tp-live-anim-spin" src="/assets/img/IECS-IEDIS IMAGES/icon-preschoool.webp" alt="">
                   </div>
                </div>
             </div>
             <div class="col-lg-5">
                <div class="tp-service-hero-right mt-55">
                   <p class="fs-20 lh-140-per">El nivel preescolar es una etapa educativa fundamental que atiende a niñas y niños desde los primeros años de vida hasta antes de ingresar a la primaria. Su propósito es favorecer el desarrollo integral de los alumnos en los ámbitos físico, cognitivo, emocional, social y comunicativo.</p>
                </div>
             </div>
          </div>
       </div>
          ...
          <div class="row">
             <div class="col-12">
                <div class="tp-service-details-title-wrap mb-50">
                   <h2 class="fs-500 fs-50 mb-5">El lugar donde comienzan los grandes aprendizajes</h2>
             ...
             <div class="col-lg-6">
                <div class="tp-service-details-content mb-40">
                   <ul>
                      <li><i class="fa-regular fa-circle-check"></i><p><b>Cognitivo –</b> Desarrollamos el pensamiento lógico, la curiosidad y la capacidad de resolver problemas a través de actividades lúdicas.</p></li>
                      <li><i class="fa-regular fa-circle-check"></i><p><b>Lenguaje –</b> Fortalecemos la comprensión y expresión oral en español e inglés, mediante cuentos, canciones, dramatizaciones y rutinas bilingües.</p></li>
                      <li><i class="fa-regular fa-circle-check"></i><p><b>Socioemocional –</b> Promovemos la empatía, la autorregulación y la convivencia sana, con estrategias como mindfulness y Empathy Rocks.</p></li>
                   </ul>
                </div>
             </div>
          </div>
